...
8. Write the module once and send it. Do not draft, revise or restate it inside
   ...
   arriving without its opening lines.
9. Keep the module under 500 lines. When you add a construct, remove one that
   has not earned its place. A generator that only grows spends its examples on
   constructs already known to reach nothing new.
