...
```
name_len             max=17       p90=16       p50=3        distinct values=9
attrs_per_element    max=101      p90=1        p50=0        distinct values=5
entity_name_len      max=21       p90=3        p50=0        distinct values=10
attr_value_len       max=3        p90=3        p50=0        distinct values=2
depth                max=3000     p90=256      p50=4        distinct values=34
```
...
```
byte_hostile   share= 36.2%  acceptance= 42.0%  n=181
near_miss      share= 14.8%  acceptance= 21.6%  n=74
well_formed    share= 49.0%  acceptance= 64.5%  n=245
```
...
Overall acceptance: **50.0%** (target band 40-70%)
...
```
Deepest document generated: 3000
...
```
    11.2 ms  len=21     depth=1   parsed_clean
    10.8 ms  len=14047  depth=2001 rejected
    10.3 ms  len=14076  depth=2001 parsed_clean
```
